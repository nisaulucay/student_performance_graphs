...
# matematik puanı dağılımı (Histogram)
...
# matematik vs okuma puanı (Scatter Plot)
plt.figure(figsize=(6,4))
plt.scatter(df['math score'], df['reading score'], color='purple', alpha=0.6)
plt.title("Matematik vs Okuma Puanı")
plt.xlabel("Matematik Puanı")
